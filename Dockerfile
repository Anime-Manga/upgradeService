...
COPY ["src/Cesxhin.AnimeManga.Domain/", "./refereces/Cesxhin.AnimeManga.Domain/"]
COPY ["src/Cesxhin.AnimeManga.Application/", "./refereces/Cesxhin.AnimeManga.Application/"]
